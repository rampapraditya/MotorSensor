...
public class Menu extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        listMenu1.addItem(new Model_Menu("5", "Data", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("9", "Extra", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("4", "Exit", Model_Menu.MenuType.MENU));
    ...
    protected void paintChildren(Graphics grphcs) {
        ...
        GradientPaint g = new GradientPaint(0, 0, Color.decode("#3b6ecc"), 0, getHeight(), Color.decode("#000000"));
        int height = 140;
