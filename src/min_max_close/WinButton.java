...
//                }
    ...
    private void initComponents() {
        ...
        cmdClose = new min_max_close.Button();
        cmdMi = new min_max_close.Button();
        cmdRe = new min_max_close.Button();
    ...
    private min_max_close.Button cmdClose;
    private min_max_close.Button cmdMi;
    private min_max_close.Button cmdRe;
